About fuse-overlayfs-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/fuse-overlayfs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fuse-overlayfs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fuse-overlayfs
# for installing globally
pixi global install fuse-overlayfs
```
...
It is possible to list all of the versions of `fuse-overlayfs` available on your platform:
...
```
pixi search fuse-overlayfs --channel conda-forge
```
